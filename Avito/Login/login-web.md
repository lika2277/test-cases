...
| 4 | Использование кнопки <Запомнить пароль> | Full | При тестировании кнопки <Забыли пароль>, была выявлена ошибка. При закрытии вкладки avito в браузере и закрытии самого браузера, позьзователь автоматически неразлогинивается, что не является безопасным если пользователь использует гостевой компьютер |